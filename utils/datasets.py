...
class Realsense:
    def __init__(self, width=640, height=480, channel_format='bgr8'):
        import pyrealsense2 as rs

        # if channel_format=='bgr8':
        #     self.format = rs.format.bgr8
        # else:
        ...
        # self.config.enable_stream(rs.stream.depth, 640, 480, self.format, 30)
        self.config.enable_stream(rs.stream.color, width, height, self.format, self.fps)
    ...
    def VideoCapture(self):
        self.cap = self.pipeline.wait_for_frames()
        ...
        # cv2.imshow('Stream', self.color_image)
        # if cv2.waitKey(1) == ord("q"):
        #     break
        # return self.cap

    def close_real_sense(self):
        # colorwriter.release()
        # depthwriter.release()
        self.pipeline.stop()

    def read(self):
        self.frame = self.cap.get_color_frame()
